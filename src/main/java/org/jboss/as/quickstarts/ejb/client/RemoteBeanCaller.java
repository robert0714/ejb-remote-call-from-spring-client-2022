...
/**
 * EJB which runs the remote calls to emthe EJBs.
 * We use the EJB here for benefit of automatic transaction management.
 */
//@Stateless
@Component
public class RemoteBeanCaller {
    private static final Logger log = LoggerFactory.getLogger(RemoteBeanCaller.class);
...
//    @TransactionAttribute(value = TransactionAttributeType.NOT_SUPPORTED)
    public List<String> remoteOutboundStatelessNoTxBeanCall() throws NamingException {
        log.debug("Calling with outbound connection without transaction to StatelessBean.successOnCall()");
    ...
    public List<String> remoteOutboundStatelessBeanCall() throws NamingException {
        log.debug("Calling with outbound connection with transaction to StatelessBean.successOnCall()");
...
//        em.persist(new CallerUser("Bilbo", "Baggins"));
    ...
    public List<String> directLookupStatelessBeanOverEjbRemotingCall() throws NamingException {
        log.debug("Calling direct lookup with transaction to StatelessBean.successOnCall()");
        ...
        final String data01 =  bean.successOnCall();
        final String data02 =  bean.successOnCall();
        System.out.println("----------------------------------------");
        System.out.println(data01);
        System.out.println(data02);
        return Arrays.asList(data01,data02);
    }
...
//    @TransactionAttribute(value = TransactionAttributeType.NOT_SUPPORTED)
    public List<String> remoteOutboundStatefulNoTxBeanCall() throws NamingException {
        log.debug("Calling with outbound connection without transaction to StatefulBean.successOnCall()");
    ...
    public String remoteOutboundStatelessBeanFail() throws NamingException {
        log.debug("Calling with failure to StatelessBean.failOnCall()");
